export default {
    ...
    "ID extractor separator": "Sorting ID separator",
    "ID extractor separator desc": "Split the filename using this separator to find the sorting ID.",
    "ID extractor separator placeholder": "Example: ，",
    "ID extractor position": "Sorting ID position",
    "ID extractor position desc": "Choose which fragment to use after splitting the filename.",
    "ID extractor position first": "Use the first fragment",
    "ID extractor position last": "Use the last fragment",
    "ID extractor field": "Sorting ID property name",
    "ID extractor field desc": "Write the extracted ID into this frontmatter property.",
    "ID extractor auto": "Auto update sorting ID on save",
    "ID extractor auto desc": "Automatically extract the sorting ID whenever the file is saved.",
    "Retrieval": "Retrieval",
    ...
    "extract sorting id": "Extract sorting ID",
    "id extractor no active file": "No active file to extract the sorting ID from.",
    "id extractor empty filename": "The filename is empty after trimming.",
    "id extractor separator missing": "The configured separator was not found in the filename.",
    "id extractor empty segment": "No valid fragment was found after splitting the filename.",
    "id extractor missing field": "Please set a property name for storing the sorting ID.",
    "id extractor success": "Sorting ID saved to {{field}}: {{id}}",
    "id extractor failure": "Failed to update the sorting ID.",
